...
import 'package:monami/src/presentation/views/bottomnavigation/navigation_items.dart';
...
class _BottomNavigationState extends State<BottomNavigation> {
      ...
      bottomNavigationBar: Container(
        ...
        child: ClipRRect(
          ...
          child: BottomNavigationBar(
            ...
            unselectedItemColor: AppColor.bgColor,
  ...
  BottomNavigationBarItem getNavigationBarItem(
    ...
    Color iconColor =
        index == currentIndex ? AppColor.blackColor : AppColor.bgColor;
